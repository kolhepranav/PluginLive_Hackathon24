...
//   const links = [
//     {url:'/main',label:'Dashboard',icon:<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
// //   const activeClasses =
// //     "bg-white text-primary px-4 py-2 mb-2 rounded-lg justify-center md:justify-start";
// //   const inactiveClasses =
// //     "text-gray-700 px-4 py-2 mb-2 flex justify-center md:justify-start hover:bg-gray-200 rounded-lg";

// //   const links = [
// //     { url: "/main", label: "Dashboard" },
// //     { url: "/main/orders", label: "Orders" },
...
// //   return (
// //     <aside className="bg-primary text-white p-5 py-12 m-2 ">
// //       <nav className=" w-20 mt-32">
// //         {links.map((link) => (

// //           <Link
// //             key={link.url}
// //             href={link.url}
// //             className={`${pathname === link.url ? activeClasses : inactiveClasses} mb-5`}
// //           >
// //             {link.label}
// //           </Link>
// //         ))}
